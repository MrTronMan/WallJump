...
public class NmsUtils {
    ...
    public static Class<?> getNmsClass(String pre1_17ClassName, String _1_17Path) throws ClassNotFoundException {
        if(BukkitUtils.isVersionBefore(BukkitUtils.Version.V1_16))
    ...
    private static Sound getSoundForBlock(Block block, String fieldName) {
        try {
            ...
            if(BukkitUtils.isVersionAfter(BukkitUtils.Version.V1_17))
            ...
            if(BukkitUtils.isVersionBefore(BukkitUtils.Version.V1_11))
                getKeyMethodName = "a";
